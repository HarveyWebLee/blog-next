...
const getSectionIcon = (sectionKey: string) => {
  const iconMap: { [key: string]: React.ReactNode } = {
    acceptance: <CheckCircle className="h-6 w-6" />,
    description: <BookOpen className="h-6 w-6" />,
    userAccounts: <Users className="h-6 w-6" />,
    contentPolicy: <FileText className="h-6 w-6" />,
    intellectualProperty: <Scale className="h-6 w-6" />,
    privacy: <Shield className="h-6 w-6" />,
    prohibitedUses: <Zap className="h-6 w-6" />,
    disclaimers: <Shield className="h-6 w-6" />,
    limitation: <Scale className="h-6 w-6" />,
    termination: <Zap className="h-6 w-6" />,
    changes: <FileText className="h-6 w-6" />,
...
export default function TermsPage({ params }: TermsPageProps) {
  ...
  const sections = Object.entries(dict.terms.sections);
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection delay={0} animation="fadeInUp">
            <div className="mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 mx-auto leading-relaxed">{dict.terms.subtitle}</p>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <AnimatedSection delay={100} animation="fadeInLeft">
                  ...
                  >
                    ...
                    {dict.terms.lastUpdated}: 2024年12月
                  </Badge>
                </AnimatedSection>
              ...
              <div className="bg-gradient-to-br from-background to-muted/20 rounded-xl p-8 border border-primary/10 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                    我们致力于为您提供优质的服务体验。如果您对本服务条款有任何疑问，
